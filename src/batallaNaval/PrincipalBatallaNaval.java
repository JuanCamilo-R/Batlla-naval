...
public class PrincipalBatallaNaval {
	...
	public static void main(String[] args) {
		 ...
		 * control = new ControlJuego(); control.crearBarcos(); //pantalla.ponerBarco(0,
		 * 0, 0, 4, 4, control.retornarBarco(0)); //pantalla.ponerBarco(0, 1, 0, 4, 4,
		 * control.retornarBarco(0));
		 * //System.out.print(control.retornarBarco(0).getTamano());
		 * //pantalla.mostrar(); control.mostrarPosicionesAtacadasCPU();
		 */
